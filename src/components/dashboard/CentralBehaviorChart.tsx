...
import { daySeries, ANALYZED_DATE } from "@/lib/mock-data";

export function CentralBehaviorChart() {
  return (
    <div className="glass-card rounded-2xl p-5">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-[15px] font-semibold tracking-tight">
            Comportamento da central <span className="text-muted-foreground font-normal">— {ANALYZED_DATE} (D-1)</span>
          </h3>
        </div>
      ...
      <div className="mt-4 h-[320px]">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={daySeries} margin={{ top: 8, right: 16, left: 0, bottom: 0 }}>
