        ...
        {series.length ? (
          <ResponsiveContainer width="100%" height="100%">
            <ComposedChart data={series} margin={{ top: 8, right: 16, left: 0, bottom: 0 }}>
              ...
              <Line yAxisId="kw" type="monotone" dataKey="kW" name="kW" stroke="var(--color-water)" strokeWidth={1.8} dot={false} connectNulls={false} />
              <Line yAxisId="kw" type="monotone" dataKey="trh" name="Carga térmica (TR)" stroke="var(--color-efficiency)" strokeWidth={1.6} dot={false} connectNulls={false} />
              <Line yAxisId="kw" type="monotone" dataKey="kwPerTr" name="kW/TR" stroke="var(--color-esg)" strokeWidth={1.4} dot={false} connectNulls={false} />
              <Line yAxisId="kw" type="monotone" dataKey="deltaT" name="Delta-T (°C)" stroke="var(--color-carbon)" strokeWidth={1.4} dot={false} connectNulls={false} />
